            ...
            <div id="table">
                <div>
                    ...
                    <table id="incomes_table" class="table table-bordered">
                        ...
                        <tbody>
                        <c:forEach items="${requestScope.topicList}" var="topic" begin="0"
                                   end="${requestScope.recordPerPage -1}">
                            <tr>
                                <td class="table-success"><c:out value="${topic.topicName}"/></td>
                                <td class="edit-delete"><a
                                        href="${pageContext.request.contextPath}/faculty<%=UPDATE_TOPIC_FORM%>?topic=${topic.topicId}">Edit</a>
                                </td>
                                <td class="edit-delete"><a
                                        href="${pageContext.request.contextPath}/faculty<%=DELETE_TOPIC_PATH%>?topic=${topic.topicId}">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
                ...
                <div class="container">
                    <p><a id="add-new" href="${pageContext.request.contextPath}/faculty<%=ADD_TOPIC_FORM%>">Add a new
                        topic</a></p>
                </div>
            </div>
        </div>
