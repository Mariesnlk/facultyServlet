    ...
    <div class="menu-item">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    <div class="logo">
                        <a href="${pageContext.request.contextPath}/faculty<%=TEACHER_ACCOUNT%>"><h2>Faculty site</h2></a>
                    </div>
                </div>
                <div class="col-lg-10">
                    <div class="nav-menu">
                        <nav class="mainmenu">
                            <ul>
                                <li><a href="${pageContext.request.contextPath}/faculty<%=TEACHER_COURSES_PAG%>?pagination=1">
                                    <fmt:message key="navbar.my_courses"/>
                                </a></li>
                                ...
                                <li><a href="${pageContext.request.contextPath}/faculty<%=CONTACTS%>">
                                    <fmt:message key="navbar.contacts"/>
                                </a></li>
                                <li>
